...
class NeuralInference(ABC):
    ...
    def get_dataloaders(
        ...
        if not resume_training:
            ...
            if dataloader_kwargs is not None: # MODIFICATION: allow for custom train/validation splitting
                if "dataloader_randperm" in dataloader_kwargs.keys():
                    permuted_indices = dataloader_kwargs["dataloader_randperm"].clone()
                    del dataloader_kwargs["dataloader_randperm"]
